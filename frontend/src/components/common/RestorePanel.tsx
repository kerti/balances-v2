...
// RestorePanel is the import half of Settings → Data (ADR-0036, issue #175). It
...
export function RestorePanel() {
  ...
  return (
    <SettingsPanel title={t("data.restore.title")} description={t("data.restore.description")}>
      <input
        ref={fileRef}
        type="file"
      ...
      {!preview && (
        <PanelActions note={t("data.restore.chooseHint")}>
          <Button
            variant="outline"
