  ...
  return (
    <div className="space-y-6">
      ...
      {data && data.length === 0 && (
        <Card>
          <CardHeader>
            <CardTitle>{t("investments:gold.emptyTitle")}</CardTitle>
            <CardDescription>{t("investments:gold.emptyBody")}</CardDescription>
          </CardHeader>
          <CardContent>
            <CreateGoldDialog />
          </CardContent>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      />
                      <TableHead>
                        {t("investments:gold.formPurityHeader")}
                      </TableHead>
                      <SortableHeader
                      ...
                      />
                      <SortableHeader
                        label={t("investments:gold.sortLatestValue")}
                        testId="sort-value"
                        align="right"
