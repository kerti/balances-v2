          ...
          <div className="space-y-3">
            <div className="grid gap-2">
              ...
              <Input
                ...
                placeholder={t(
                  "investments:timeDeposit.placeholders.displayName",
                )}
              />
            </div>
            <div className="grid gap-2">
          ...
          <div className="space-y-3 border-t pt-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder={t(
                    "investments:timeDeposit.placeholders.bankName",
                  )}
                />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="td_currency">
                ...
                <Input
                  ...
                  placeholder={t(
                    "investments:timeDeposit.placeholders.currency",
                  )}
                  maxLength={3}
                />
              </div>
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                placeholder={t(
                  "investments:timeDeposit.placeholders.principal",
                )}
              />
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder={t(
                    "investments:timeDeposit.placeholders.termMonths",
                  )}
                />
              </div>
            </div>
            ...
            <div className="grid gap-2">
              ...
              >
                <option value="auto_renew_principal">
                  {t(
                    "investments:timeDeposit.rolloverPolicy.auto_renew_principal",
                  )}
                </option>
