...
export function MutualFundDetail({ investmentId, onBack }: Props) {
  ...
  const createSnapshotMutation = useCreateInvestmentSnapshot(investmentId, "mutual-funds");
  const updateSnapshotMutation = useUpdateInvestmentSnapshot(investmentId, "mutual-funds");
  const deleteSnapshotMutation = useDeleteInvestmentSnapshot(investmentId, "mutual-funds");
  const importSnapshotMutation = useImportInvestmentSnapshots(investmentId, "mutual-funds");
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <DetailTagControl
            group="investment"
            positionId={mf.investment.id}
            currentTagId={mf.investment.tag_id}
          />
        </div>
      ...
      <Card data-testid="tour-details">
        ...
        {mf.investment.description && (
          <CardContent className="text-sm">{mf.investment.description}</CardContent>
        )}
      </Card>
        ...
        <CardHeader>
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <CardDescription>{t("investments:mutualFund.snapshotsDescription")}</CardDescription>
            </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-right">
                      {t("investments:mutualFund.navHeader")}
                    </TableHead>
                    <TableHead className="text-right">
